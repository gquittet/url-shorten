...
export class Migration20220606204433 extends Migration {
  ...
  async down(): Promise<void> {
    this.addSql('create table "shortcode" ("id" varchar(255) not null, "shortcode" varchar(255) not null, "url" varchar(2048) not null, "hits" int not null default 0, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "status" text check ("status" in (\'disabled\', \'enabled\')) not null);');
